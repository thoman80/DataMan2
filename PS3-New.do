Galadriel Thoman
PS3 Redo //this must be a comment!
Stata Version 16 //again, as i said earlier this is illegal command!
...
//i have no idea where these come from! again need to cite data properly!!! you say world bank but need to give link to exact dataset OR give exact steps how to get it
//and these are from the same source! again need from various sources!
...
//we discussed in class--these must be more efficient
...
//nothing merged here--this needs to be investigated and fixed and it creates mess for later !!! so i stop commenting here
tab _merge5
