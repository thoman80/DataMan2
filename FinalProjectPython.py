...
## Add hypotheses, list variables, and research questions to final projects- try setting up the way Jasmyne did, by question and analysis- due date is now December 15 at 10pm- tabstat for stata portion? Try drop if countryname==., or drop _merge==2- don't use drop (number) because it's not replicable ##
